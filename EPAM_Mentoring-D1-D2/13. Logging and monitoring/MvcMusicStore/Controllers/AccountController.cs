...
namespace MvcMusicStore.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        private static CounterHelper<PerfomanceCounters> _counterHelper;
        ...
        {
            _counterHelper = PerformanceHelper.CreateCounterHelper<PerfomanceCounters>("MvcMusicStore");
            this._logger = LogManager.GetLogger("AccountController");
        }
        ...
        public ActionResult LogOff()
        {
            ...
            _counterHelper.Increment(PerfomanceCounters.LogOffCounter);
        ...
        private async Task SignInAsync(ApplicationUser user, bool isPersistent)
        {
            ...
            _counterHelper.Increment(PerfomanceCounters.LogInCounter);
